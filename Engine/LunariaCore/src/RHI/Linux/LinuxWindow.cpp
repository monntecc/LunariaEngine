...
#include "LunariaEngine/Core/Application.hpp"
#include "LunariaEngine/Events/ApplicationEvent.hpp"
#include "LunariaEngine/Events/KeyEvent.hpp"
#include "LunariaEngine/Events/MouseEvent.hpp"

#include "LunariaEngine/RHI/OpenGL/OpenGLContext.hpp"
#include "LunariaEngine/RHI/Linux/LinuxWindow.hpp"

#include "LunariaEngine/Renderer/Renderer.hpp"
...
namespace Lunaria {
    ...
    void LinuxWindow::Init(const WindowProps& props)
    {
        ...
        if (s_GLFWWindowCount == 0)
        {
            ...
            LU_CORE_INFO("Initializing GLFW");
            ...
            LU_CORE_ASSERT(_, "Could not initialize GLFW!");
