...
namespace Lunaria::Windowing::Settings {

    /**
    * Contains window settings
    */
    struct LUNARIA_API WindowSettings
    {
        /**
        ...
        */
        Cursor::LCursorMode cursorMode = Cursor::LCursorMode::NORMAL;

        /**
        * Specifies the default cursor shape of the window
        */
        Cursor::LCursorShape cursorShape = Cursor::LCursorShape::ARROW;
