...
#include "LunariaECS/Actor.hpp"

namespace Luanria::ECS {

    template<typename T, typename ...Args>
    inline T& Lunaria::ECS::Actor::AddComponent(Args&& ...p_args)
    {
    ...
    template<typename T>
    inline bool Lunaria::ECS::Actor::RemoveComponent()
    {
        static_assert(std::is_base_of<Components::AComponent, T>::value, "T should derive from AComponent");
    ...
    template<typename T>
    inline T* Lunaria::ECS::Actor::GetComponent() const
    {
        static_assert(std::is_base_of<Components::AComponent, T>::value, "T should derive from AComponent");
